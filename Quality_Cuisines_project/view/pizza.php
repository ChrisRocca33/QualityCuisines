...
<div class="display">
    ...
    <br><br>
    <h1><?php echo RecipeController::getRecipeByNo(1)->getRecipeName();  ?></h1>
    <img src="../view/images/pizza.png" class="pizza">
    <h2>Ingredients</h2>
    <p><?php echo RecipeController::getRecipeByNo(1)->getIngredients();  ?></p>
    <h2>Instructions</h2>
    <p><?php echo InstructionsController::getInstructionsByNo(1)->getInsText();  ?></p>
</body>
</html>